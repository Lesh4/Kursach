...
check_entry - функция для проверки вводимых данных:
...
methods_funcs - второстепенные функции для корректной работы методов решения ДУ:
    check_znaki - функция для нахождения необходимого количества знаков после запятой у численных результатов методов;
